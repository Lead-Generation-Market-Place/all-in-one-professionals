...
class AddServicePricing extends StatefulWidget {
  const AddServicePricing({super.key});

  @override
  State<AddServicePricing> createState() => _AddServicePricingState();
}

class _AddServicePricingState extends State<AddServicePricing> {
                      ...
                      if (res == true) {
                        if (mounted) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text(
                                "Service pricing added successfully",
                              ),
                            ),
                          );
